...
<div class="container p-3">
	...
	<form:form action="/songs/update" method="post" modelAttribute="song">
		...
		<div class="number mb-2">
			...
			<form:input type="number" path="rating" min="1" max="10" class="form-control"/>
		</div>
		
		<input type="submit" value="Edit Song" class="btn btn-primary" />
